    ...
    <div className="min-h-screen bg-white pt-20">
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 to-indigo-100">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            Experience our latest experimental features and help us shape the future of AI tools
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            <h2 className="text-3xl font-bold mb-6">Beta Program</h2>
            <p className="text-xl text-gray-600 mb-8">
              Join our beta program to test cutting-edge features before they go live. Your feedback helps us build better tools for everyone.
            </p>
          </motion.div>
        </div>
      </section>
